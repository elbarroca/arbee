            ...
            <div className="p-4 md:p-6 border-b border-white/10 bg-[#0c0c0c]">
              <div className="flex justify-between items-start mb-4 gap-2">
                <div className="flex-1 min-w-0">
                    <div className="flex gap-2 mb-2 flex-wrap">
                        <span className="px-2 py-0.5 rounded bg-blue-500/20 text-blue-400 text-xs font-bold border border-blue-500/30 whitespace-nowrap">
                            Rank #{trader.rank_in_tier}
                        </span>
                        <span className="px-2 py-0.5 rounded bg-zinc-800 text-zinc-400 text-xs font-mono border border-white/5 whitespace-nowrap">
                            Tier {trader.tier}
                        </span>
                    </div>
              ...
              <div className="grid grid-cols-2 gap-3 md:gap-4">
                  ...
                  <div className="bg-zinc-900 p-2.5 md:p-3 rounded-lg border border-white/5">
                      ...
                      <div className="text-base md:text-lg font-mono font-bold text-purple-400 truncate">{trader.composite_score?.toFixed(1)}</div>
                  </div>
              </div>

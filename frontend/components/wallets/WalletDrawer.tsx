    ...
    <AnimatePresence>
      {wallet && (
        <>
          ...
          >
            {/* 1. Header Section */}
            <div className="p-8 pb-6 border-b border-white/10 bg-[#0c0c0c]">
              <div className="flex justify-between items-start mb-6">
                <div>
                   ...
                   <h2 className="text-xl md:text-2xl font-bold text-white font-mono break-all">
                     {wallet.proxy_wallet}
                   </h2>
                </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="p-4 rounded-xl bg-zinc-900/50 border border-white/5">
                  ...
                  <div className={cn("text-xl font-mono font-bold", (wallet.realized_pnl || 0) >= 0 ? "text-emerald-400" : "text-red-400")}>
            ...
            <div className="flex-1 overflow-y-auto p-6 md:p-8 bg-[#050505]">
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="text-xs text-zinc-600">{effectiveTrades.length} records fetched</span>
              </div>
              ...
              {loading ? (
                ...
                <div className="space-y-4">
                  {effectiveTrades.map((trade) => {
                    ...
                    return (
                      <div key={trade.id} className="group relative p-5 rounded-xl border border-white/5 bg-zinc-900/20 hover:bg-zinc-900/40 transition-all hover:border-white/10">

                        {/* Top Row: Header */}
                        <div className="flex justify-between items-start gap-4 mb-4">
                          <div className="flex items-start gap-3 flex-1">
                             <div className="w-10 h-10 rounded-md bg-zinc-800 flex items-center justify-center text-xs font-bold text-zinc-500">PM</div>
                             <div>
                                <h4 className="text-sm font-medium text-zinc-200 leading-snug mb-1 line-clamp-2">
                                  {trade.title}
                                </h4>
                                <div className="flex items-center gap-2 text-[10px] text-zinc-500">
                                   <span>{trade.event_category}</span>
                                   <span>•</span>
                          ...
                          <div className="text-right flex-shrink-0">
                             <div className={cn("text-lg font-mono font-bold", isProfit ? "text-emerald-400" : "text-red-400")}>
                        ...
                        <div className="bg-[#0a0a0a] rounded-lg p-3 border border-white/5 mb-3">
                           <div className="flex items-center justify-between text-xs">
                              {/* Outcome Side */}
                              <div className="flex flex-col gap-1">
                                 <span className="text-zinc-500 text-[10px] uppercase">Position</span>
                                 <span className={cn(
                                   "px-2 py-0.5 rounded text-[11px] font-bold border self-start",
                              ...
                              <div className="flex items-center gap-3">
                                 <div className="text-right">
                                    ...
                                    <div className="font-mono text-zinc-300">{cents(entry)}¢</div>
                                 </div>
                                 <ArrowRight className="w-4 h-4 text-zinc-600" />
                                 <div className="text-left">
                                    <div className="text-zinc-500 text-[10px] uppercase">Exit</div>
                                    <div className={cn("font-mono font-bold", statusColor)}>
                                      {cents(exit)}¢
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div className="text-right">
                                 ...
                                 <div className="font-mono text-zinc-300">{currency(invested)}</div>
                              </div>
                           </div>
                        </div>
